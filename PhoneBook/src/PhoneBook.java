...
public class PhoneBook {
    ...
    public static String[][] add(String[][] book, String name, String number, int i) {    // массив-заготовка телефонной книги
        book[i][0] = name;
        book[i][1] = number;
        list(book);
        return book;
    ...
    public static void list(String[][] book) {              // список контактов
